...
const Dashboard = () => {
  ...
  const handleBack = () => {
    ...
    // Alternatively, navigate to a specific route: navigate('/');
  };
      ...
      <div className="bg-gray-50 min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          >
            <button
                onClick={handleBack}
                className="flex items-center bg-white text-blue-600 px-4 py-2 rounded-xl font-medium hover:bg-blue-50 transition duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            >
              <svg
            ...
            <div className="relative z-10">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                ...
                <div className="mt-4 md:mt-0">
                  <Link
                      to="/book"
                      className="bg-white text-blue-600 px-6 py-3 rounded-xl font-medium hover:bg-blue-50 transition duration-300 inline-block transform hover:scale-105"
                  >
                    Book New Ticket
                  </Link>
                </div>
              ...
              <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden mt-6">
                ...
                <div className="p-6">
                  ...
                  <div className="mt-6 space-y-2">
                    <Link
                        to="/customer/profile"
                        className="block w-full bg-gray-100 text-gray-800 text-center px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-200 transition-colors"
                    >
                      Edit Profile
                    </Link>
