...
const routeOptions = [
  ...
  { id: 2, name: "Boston to Washington DC" },
  { id: 3, name: "Philadelphia to New York" },
  { id: 4, name: "Washington DC to Philadelphia" },
  { id: 5, name: "Boston to New York" },
  { id: 6, name: "New York to Washington DC" },
]
