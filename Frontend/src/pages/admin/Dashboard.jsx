...
const dashboardData = {
  stats: [
    { name: "Total Users", value: "7,842", icon: "users", change: "+12%" },
    { name: "Active Buses", value: "124", icon: "bus", change: "+3%" },
    { name: "Bookings Today", value: "329", icon: "ticket", change: "+18%" },
    { name: "Revenue (MTD)", value: "$67,294", icon: "money", change: "+22%" },
  ],
  recentBookings: [
    {
      id: "BK12345",
  ...
  popularRoutes: [
    { route: "New York to Boston", bookings: 487, revenue: "$17,045" },
    { route: "Boston to Washington", route: 356, revenue: "$14,956" },
    { route: "Philadelphia to New York", bookings: 312, revenue: "$7,800" },
    { route: "Washington to Philadelphia", bookings: 284, revenue: "$8,094" },
  ],
}
